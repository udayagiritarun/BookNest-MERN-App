...
function Products() {
  ...
  {isItemInWishlist(item._id) ? (
    <Button style={{ backgroundColor: 'red', border: 'none' }} onClick={() => removeFromWishlist(item._id)}>
      Remove from Wishlist
    </Button>
  ) : (
    <Button style={{ backgroundColor: 'rebeccapurple', border: 'none' }} onClick={() => addToWishlist(item._id)}>
      Add to Wishlist
    </Button>
  )}

  <Button style={{ backgroundColor: 'teal', border: 'none' }}>
